...
// 7. Using a for-loop, iterate through this array and after console.log-ing "Mary", exit from
// the loop. (hint: use break keyword to exit loop)
...
// 8. Write the command to make a copy of the array using slice. The copy should NOT
// include "Mary" or "Matt".
let people2 = people.slice(2);
console.log(people2);

// 9. Redefine the people variable with the value you started with. Using the splice
// command, remove "Devon" from the array and add "Elizabeth" and "Artie". Your
// array should look like this when you are done ["Matt", "Mary", "Elizabeth",
// "Artie", "Your Name"].
let people3 = people.splice(2, 1, "Elizabeth", "Artie")
console.log(people);

// 10.Create a new variable called withBob and set it equal to the people array
